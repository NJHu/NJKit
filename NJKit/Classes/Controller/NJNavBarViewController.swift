...
open  class NJNavBarViewController: UIViewController {
    ...
    private let nj_backBtn: UIButton = UIButton(type: UIButton.ButtonType.custom)
    ...
    open override func viewDidLayoutSubviews() {
        ...
        view.bringSubviewToFront(nj_navigationBar)
...
extension NJNavBarViewController {
    private func nj_addNavBar () {
        ...
        let heightConstraint = NSLayoutConstraint(item: nj_navigationBar, attribute: NSLayoutConstraint.Attribute.height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: NSLayoutConstraint.Attribute.height, multiplier: 0, constant: 44.0 + UIApplication.shared.statusBarFrame.size.height)
        nj_navigationBar.addConstraint(heightConstraint)
        self.heightConstraint = heightConstraint
        view.addConstraint(NSLayoutConstraint(item: nj_navigationBar, attribute: NSLayoutConstraint.Attribute.left, relatedBy: NSLayoutConstraint.Relation.equal, toItem: view, attribute: NSLayoutConstraint.Attribute.left, multiplier: 1, constant: 0))
        view.addConstraint(NSLayoutConstraint(item: nj_navigationBar, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: view, attribute: NSLayoutConstraint.Attribute.top, multiplier: 1, constant: 0))
        view.addConstraint(NSLayoutConstraint(item: nj_navigationBar, attribute: NSLayoutConstraint.Attribute.right, relatedBy: NSLayoutConstraint.Relation.equal, toItem: view, attribute: NSLayoutConstraint.Attribute.right, multiplier: 1, constant: 0))
    }
    private func nj_addBackBtn() {
        nj_backBtn.setImage(UIImage.nj_image(name: "NJKit_navigation_Button_Return_Normal", bundleClass: NJNavBarViewController.self), for: UIControl.State.normal)
        nj_backBtn.setImage(UIImage.nj_image(name: "NJKit_navigation_Button_Return_Click", bundleClass: NJNavBarViewController.self), for: UIControl.State.highlighted)
        ...
        nj_backBtn.addTarget(self, action: #selector(nj_backBtnClick(btn:)), for: UIControl.Event.touchUpInside)
    }
